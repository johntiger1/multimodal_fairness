# This file is just main.py with a minor tweak to instead test on the train data. After it produces a .csv for the
# train data, you still need to reun the post-processing script
