...
if __name__ == "__main__":
    ...
    if cmd == "LOAD":
    ...
    elif cmd == "PLOT_ALL6": # Same as PLOT_ALL5, just smaller markers
                             # TN,TP and AUC together, with legend, for u,s,en,d,den; NO DP!
        # unstructured
        u_train_file = sys.argv[2]
        u_test_file = sys.argv[3]
        ...
        plt.grid(False)
        plt.tight_layout()
        plt_name = sensitive_attr + "_t7.png"
    ...
    elif cmd == "PLOT_ALL7": # Same as PLOT_ALL5, just smaller markers
                             # TN,TP and AUC together, with legend, for u,s,en,d,den; NO DP!
        # unstructured
        u_train_file = sys.argv[2]
        u_test_file = sys.argv[3]
        ...
        plt.grid(False)
        plt.tight_layout()
        plt_name = sensitive_attr + "_t8.png"
        ...
        if len(lines) <= 8:
            ...
            fig.legend(lines, labels, ncol=8, loc='lower center')
            fig.set_size_inches(12, 4.6)
            plt.subplots_adjust(left=0.07, bottom=0.25, right=0.98, top=None, wspace=0.2, hspace=None)
        plt.savefig(plt_name)
